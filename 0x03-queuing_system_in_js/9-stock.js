...
// express
// Create an express server that is listening on the port 1245.
...
// Create the route GET /list_products that will return 
// the list of every available product with specified JSON format
app.get('/list_products', (req, res) => {
  res.json(listProducts);
});

// Product details, returns current product and the current 
// available stock (by using getCurrentReservedStockById), JSON
